...
首先查阅 [飞书文档 Self-Evolving Agents for Scientific Research: Literature Review](https://complife-lab.feishu.cn/wiki/ViyowMCymiPhR2kOWLocs9Kmndc#outline) 的领域架构。该文档基于行业综述 [A Survey of Self-Evolving Agents](../../doc/papers/01_foundations/2026-01_Self-Evolving_Agents_Survey.pdf)，把 self-evolving agent 拆成四个问题：What to Evolve、When to Evolve、How to Evolve、Evaluation。
