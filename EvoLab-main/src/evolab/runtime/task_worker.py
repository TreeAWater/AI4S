...
class TaskWorker:
    ...
    def _save_run_ledger(
        ...
        *,
        ...
        recorded_meta_run_refs = (
            []
            if status == "running" or result_meta_run_refs
            else self._recorded_meta_run_refs(request.task_id)
        )
        recorded_subagent_run_refs = (
            []
            if status == "running" or result_subagent_run_refs
            else self._recorded_subagent_run_refs(request.task_id)
        )
