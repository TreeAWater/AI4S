...
SEED_GRAPH_PATH = Path("dev/configs/skills/graphs/scientific_ie_seed_graph_v1.json")
BIOLOGY_PACKAGE_DIR = Path("dev/domain_packages/biology_component_extraction_v1")
