...
def test_lightweight_graph_validates_with_skill_nodes():
    payload = json.loads(Path("configs/skills/graphs/scientific_ie_seed_graph_v1.json").read_text(encoding="utf-8"))
...
def test_retrieval_trace_and_top_k_are_deterministic_for_seed_graph():
    backend = GraphSkillBackend("configs/skills/graphs/scientific_ie_seed_graph_v1.json")
...
def test_retrieval_does_not_mutate_graph_group_or_package_files():
    paths = [
        Path("configs/skills/graphs/scientific_ie_seed_graph_v1.json"),
        Path("configs/skills/groups/scientific_ie_v1.yaml"),
        Path("skills/scientific_ie/scientific_document_intake/metadata.yaml"),
        Path("skills/scientific_ie/scientific_document_intake/SKILL.md"),
    ]
...
def test_graph_skill_store_loads_registry_for_seed_group():
    loaded = GraphSkillStore("configs/skills/graphs/scientific_ie_seed_graph_v1.json").load_graph()
